...
module ArtikCloud
  # 
  class DeviceTypePricingTier
    # revenue share percentage
    attr_accessor :revenue_share_percent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'revenueSharePercent')
        self.revenue_share_percent = attributes[:'revenueSharePercent']
      end
      ...
      if attributes.has_key?(:'ptType')
        self.pt_type = attributes[:'ptType']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          revenue_share_percent == o.revenue_share_percent &&
          tiers == o.tiers &&
    ...
    def hash
      [revenue_share_percent, tiers, modified_on, comments, dtid, contact_info, pt_type, version, created_on, status].hash
    end
