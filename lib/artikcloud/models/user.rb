...
module ArtikCloud
  ...
  class User
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'saIdentity')
        self.sa_identity = attributes[:'saIdentity']
      end
    ...
    def hash
      [id, name, email, full_name, sa_identity, created_on, modified_on].hash
    end
